// Context mode selector: User Mode vs Retailer Mode with domain picker
import { useState } from 'react';
import { User, Store, ChevronDown } from 'lucide-react';
import { type AppContext, type DomainType, DOMAINS } from '@/lib/domainData';
...
export function ContextSelector({ context, domain, onContextChange, onDomainChange }: ContextSelectorProps) {
