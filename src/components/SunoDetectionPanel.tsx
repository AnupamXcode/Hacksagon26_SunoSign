import { type SunoGestureResult } from '@/lib/sunoGesture';
import { Progress } from '@/components/ui/progress';
import { Activity, Hand } from 'lucide-react';

interface SunoDetectionPanelProps {
  result: SunoGestureResult;
  isActive: boolean;
}

const FINGER_NAMES = ['Thumb', 'Index', 'Middle', 'Ring', 'Pinky'];

export function SunoDetectionPanel({ result, isActive }: SunoDetectionPanelProps) {
